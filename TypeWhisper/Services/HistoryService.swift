...
final class HistoryService: ObservableObject {
    ...
    func seedDemoData() {
        ...
        let entries: [DemoEntry] = [
            ...
            DemoEntry(dayOffset: 1, hourOffset: 13, rawText: "今天下午三点有个客户会议，需要提前准备好演示文稿和最新数据。", finalText: "今天下午三点有个客户会议，需要提前准备好演示文稿和最新数据。", appName: "备忘录", bundleId: "com.apple.Notes", appURL: nil, duration: 7.2, language: "zh", engine: "whisper"),
            ...
            DemoEntry(dayOffset: 3, hourOffset: 14, rawText: "李总您好，合同条款已更新，请查收附件并核对各项修改内容。", finalText: "李总您好，合同条款已更新，请查收附件并核对各项修改内容。", appName: "邮件", bundleId: "com.apple.mail", appURL: nil, duration: 8.8, language: "zh", engine: "whisper"),
            ...
            DemoEntry(dayOffset: 4, hourOffset: 16, rawText: "请在明天之前完成 Logo 的设计稿，颜色要符合品牌规范。", finalText: "请在明天之前完成 Logo 的设计稿，颜色要符合品牌规范。", appName: "Slack", bundleId: "com.tinyspeck.slackmacgap", appURL: nil, duration: 7.1, language: "zh", engine: "whisper"),
